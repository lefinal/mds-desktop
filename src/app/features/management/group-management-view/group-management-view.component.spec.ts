...
import { GroupManagementView, IGroupTableContent } from './group-management-view.component';
...
describe('GroupManagementView', () => {
  ...
  const sampleIGroupTableContents: IGroupTableContent[] = [
    {
  ...
  const samplePaginatedGroupsTableContents: Paginated<IGroupTableContent> = new Paginated<IGroupTableContent>(sampleIGroupTableContents, {
    limit: 3,
    retrieved: 3,
    total: 44,
    offset: 0,
  ...
  describe('fixture', () => {
    ...
    it('calling edit group to navigate to edit group view', fakeAsync(async () => {
      const sampleGroup: Group = {
        id: 'pour',
        title: 'holy',
        description: 'enter',
